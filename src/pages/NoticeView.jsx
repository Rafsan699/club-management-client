...
/*
|--------------------------------------------------------------------------
| Responsive A4 Document Component
|--------------------------------------------------------------------------
| IMPORTANT:
| The internal A4 canvas always uses the original 794 x 1123 coordinate
| system so all existing document positioning remains unchanged.
|
...
const ResponsiveA4Page = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const updateScale = () => {
      ...
      /*
       * Never allow the internal A4 document to become larger than
       * the original desktop size.
       */
      const calculatedScale = Math.min(
        currentWidth / A4_WIDTH,
        1
      );

      const calculatedHeight = A4_HEIGHT * calculatedScale;
    ...
    /*
     * ResizeObserver is the primary responsive mechanism.
     * It reacts to actual container width changes rather than only
    ...
    <div
      className={`min-h-screen ${
        darkMode
          ...
          : 'bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 text-slate-900'
      } font-serif selection:bg-emerald-600 selection:text-white pb-20`}
    >
      <Navbar
        darkMode={darkMode}
      ...
      <div
        ...
        } backdrop-blur-xl pt-28 pb-16 px-4 sm:px-8 shadow-sm`}
      >
        ...
        <div className="max-w-6xl mx-auto flex flex-col items-center text-center space-y-4 relative z-10">
          ...
          >
            ...
            Verified Institutional Publications
          </div>
          ...
          <p
            className={`text-xs sm:text-sm ${
              darkMode
                ? 'text-slate-400'
                : 'text-slate-600'
            } max-w-2xl leading-relaxed font-sans`}
          >
          ...
          <div className="w-full max-w-xl mt-4 flex flex-col sm:flex-row items-center gap-3">
            <div className="w-full relative">
              ...
              <input
                ...
                className={`w-full ${
                  darkMode
                    ? 'bg-slate-900/80 border-slate-800 text-slate-100 placeholder-slate-500 focus:border-emerald-500 focus:ring-emerald-500'
                    : 'bg-white/80 border-slate-200 text-slate-800 placeholder-slate-400 focus:border-blue-600 focus:ring-blue-600'
                } border rounded-xl px-4 py-2.5 pl-10 text-xs focus:outline-none focus:ring-1 transition-all font-sans shadow-sm backdrop-blur-md`}
              />
            </div>
            ...
            <div className="w-full sm:w-auto relative flex items-center gap-2">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className={`w-full sm:w-44 ${
                    darkMode
                      ? 'bg-slate-900/80 border-slate-800 text-slate-100 focus:border-emerald-500 focus:ring-emerald-500'
                      : 'bg-white/80 border-slate-200 text-slate-800 focus:border-blue-600 focus:ring-blue-600'
                  } border rounded-xl px-3 py-2.5 pl-10 text-xs focus:outline-none focus:ring-1 transition-all font-sans shadow-sm backdrop-blur-md cursor-pointer`}
                />
              </div>
              ...
              {selectedDate && (
                <button
                  ...
                  } border rounded-xl transition-all shadow-sm cursor-pointer`}
                >
                  <X className="w-4 h-4" />
                </button>
              )}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 mt-10">
        {filteredNotices.length === 0 ? (
          <div
            ...
            } border rounded-2xl p-12 text-center space-y-3 backdrop-blur-md shadow-lg`}
          >
            ...
            <p className="text-xs text-slate-500 font-sans">
              Try modifying your search criteria or clearing the date filter.
            </p>
          </div>
        ) : (
          <>
              ...
              {currentNotices.map((n) => (
                ...
                >
                  ...
                  <div
                    ...
                    } border rounded-xl backdrop-blur-md shadow-sm font-sans`}
                  >
                    <div className="flex items-center gap-2 text-xs font-medium truncate">
                      ...
                      <span className="truncate tracking-wide">
                        {n.title || 'Untitled Notice Document'}
                      </span>
                    </div>
                  ...
                  */}
                  <ResponsiveA4Page>
                    ...
                    {n.watermarkImg && (
                      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
                        <img
                          ...
                          style={{
                            width:
                              n.watermarkSize || '320px',
                            opacity:
                              n.watermarkOpacity || '0.10'
                          }}
                      ...
                      <div className="flex justify-between items-center relative px-12 pt-1 pb-2">
                        ...
                        >
                          {n.logoLeft ? (
                            ...
                            <div className="text-[9px] border rounded-full w-full h-full flex items-center justify-center text-slate-400">
                              Logo 1
                            </div>
                          )}
                        </div>
                        ...
                        <div className="text-center px-4">
                          <h2 className="text-[26px] font-extrabold tracking-wide uppercase leading-tight font-serif text-slate-900">
                            {n.clubName}
                          </h2>

                          <p className="text-[13px] font-bold tracking-wide uppercase font-serif text-slate-900 mt-1">
                            {n.clubSubName}
                          </p>
                        </div>
                    ...
                    {/* 
                    |--------------------------------------------------------------------------
                    | Dynamic Notice Text Boxes
                    |--------------------------------------------------------------------------
                    | Existing coordinate system is intentionally unchanged.
                    */}
                    <div className="relative flex-grow z-10 my-2">
                      {n.textBoxes &&
                      typeof n.textBoxes === 'string'
                        ? JSON.parse(n.textBoxes).map(
                            (box) => (
                              <div
                                key={box.id}
                                style={{
                    ...
                    <div className="pt-2 space-y-4 z-10">
                      ...
                      <div
                        className={`bg-gradient-to-r ${
                          n.footerTheme ||
                          'from-indigo-950 via-rose-600 to-indigo-950'
                        } text-white ${
                          n.footerFontSize ||
                          'text-[8.5px]'
                        } py-2 px-8 flex flex-col gap-1 -mx-10 -mb-8 font-serif`}
                      >
            ...
            {totalPages > 1 && (
              <div
                ...
                } border px-6 py-4 rounded-2xl backdrop-blur-md shadow-lg font-sans`}
              >
                ...
                <div className="flex items-center gap-1.5 overflow-x-auto max-w-full py-1">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 px-3 py-1.5 rounded-lg ${
                      darkMode
                        ? 'bg-slate-800 border-slate-700 text-slate-300 hover:bg-emerald-600 hover:text-white'
                        : 'bg-white border-slate-200 text-slate-700 hover:bg-blue-600 hover:text-white'
                    } border text-xs font-medium disabled:opacity-40 transition-all cursor-pointer disabled:cursor-not-allowed shadow-sm`}
                  >
                                ...
                                currentPage === pageNum
                                  ? `${
                                      darkMode
                                        ? 'bg-emerald-600'
                                        : 'bg-blue-600'
                                    } text-white font-bold scale-105 shadow-emerald-500/25`
                                  : `${
                                      darkMode
